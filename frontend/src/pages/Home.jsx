  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative py-8 sm:py-16 w-full overflow-hidden"
      >
        <FadeInOnScroll>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative py-8 sm:py-16 bg-white/50 w-full overflow-hidden"
      >
        <FadeInOnScroll>
          <BestSeller />
        </FadeInOnScroll>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative py-8 sm:py-16 bg-gradient-to-r from-pink-50/50 to-purple-50/50 w-full overflow-hidden"
      >
        <FadeInOnScroll>
          <div className="relative w-full">
            <WomenRow />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative py-8 sm:py-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 w-full overflow-hidden"
      >
        <FadeInOnScroll>
          <div className="relative w-full">
            <TeamSection />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative py-8 sm:py-16 bg-gradient-to-r from-primary/10 via-blue-500/10 to-purple-500/10 w-full overflow-hidden"
      >
        <FadeInOnScroll>
          <div className="relative w-full">
            <NewsLetter />
