...
const Navbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-200 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70 shadow-sm">
            ...
            <div className="hidden sm:flex items-center gap-6 lg:gap-8">
                <NavLink to="/" className={({isActive})=>`hover:text-primary transition ${isActive? 'text-primary font-semibold':''}`}>Home</NavLink>
                <NavLink to="/products" className={({isActive})=>`hover:text-primary transition ${isActive? 'text-primary font-semibold':''}`}>Products</NavLink>
                <NavLink to="/categories" className={({isActive})=>`hover:text-primary transition ${isActive? 'text-primary font-semibold':''}`}>Categories</NavLink>
                <NavLink to="/offers" className={({isActive})=>`hover:text-primary transition ${isActive? 'text-primary font-semibold':''}`}>Offers</NavLink>
                <NavLink to="/faq" className={({isActive})=>`hover:text-primary transition ${isActive? 'text-primary font-semibold':''}`}>FAQ</NavLink>
                <NavLink to="/about" className={({isActive})=>`hover:text-primary transition ${isActive? 'text-primary font-semibold':''}`}>About</NavLink>
                <NavLink to="/contacts" className={({isActive})=>`hover:text-primary transition ${isActive? 'text-primary font-semibold':''}`}>Contacts</NavLink>


                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full focus-within:ring-2 focus-within:ring-primary/30">
