...
const ProductCard = ({ product }) => {
  ...
  return product && (
    <FadeInOnScroll>
      <div className="bg-white p-3 sm:p-4 rounded-md transition duration-300 hover:shadow-xl h-full flex flex-col">
        {/* Image */}
        <div
          onClick={() => {
        ...
        {/* Info */}
        <div className="text-gray-800/60 text-base sm:text-lg mt-3 sm:mt-4 flex-1 flex flex-col">
          ...
          {/* Price + Button layout */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-3 sm:mt-4 gap-2 sm:gap-3 mt-auto">
            {/* Price */}
